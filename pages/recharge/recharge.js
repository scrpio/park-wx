...
Page({
  ...
  wxPay: function (openId) {
    ...
    orderInfo.notify_url = 'http://localhost:8888/api/wxPay/payResult'  // 通知地址
  ...
  setBalance: function(e){
    ...
    recharge.openId = wx.getStorageSync('openId')
    recharge.nickname = member.nickName
    recharge.license = member.license
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        wx.navigateTo({
          url: '../success/success?orderId=' + res.data.data.orderId
        })
      }
    })
  },
